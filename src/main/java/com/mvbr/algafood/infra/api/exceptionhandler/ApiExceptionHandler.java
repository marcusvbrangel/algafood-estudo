...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<?> handleEntidadeExistente(EntidadeExistenteException ex, WebRequest request) {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        Problem problem = createProblemBuilder(statusInternal, problemType, "campo obrigatório")
            .userMessage(detail)
    ...
    protected ResponseEntity<Object> handleNoHandlerFoundException(
        ...
        HttpStatus statusInternal = HttpStatus.NOT_FOUND;
    ...
    private ResponseEntity<Object> handlePropertyBinding(
        ...
        Problem problem = createProblemBuilder(statusInternal, problemType, detail)
    ...
    public ResponseEntity<Object> handleUncaught(Exception ex, WebRequest request) {
        ...
        return handleExceptionInternal(ex, problem, new HttpHeaders(), statusInternal, request);
    }
