...
alter table foto_produto add constraint uk_foto_produto_nome_arquivo unique (nome_arquivo);

create index idx_foto_produto_nome_arquivo on foto_produto (nome_arquivo);

alter table foto_produto add constraint fk_foto_produto_produto foreign key (produto_id) references produto;
