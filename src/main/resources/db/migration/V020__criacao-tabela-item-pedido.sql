...
alter table item_pedido add constraint fk_pedido foreign key (pedido_id) references pedido;

alter table item_pedido add constraint fk_produto foreign key (produto_id) references produto;
